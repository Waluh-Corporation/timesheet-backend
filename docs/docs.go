            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.RegistrationListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/response.RegistrationDetailResponse"
                        }
                    },
                    "400": {
        ...
        "/api/v1/admin/registrations/{id}/review": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Review notes and action payload",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/request.ReviewRegistrationRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid action or ID",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
                    ...
                    "409": {
                        "description": "Registration already reviewed",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
    ...
    "definitions": {
        ...
        "request.ReviewRegistrationRequest": {
            ...
            "properties": {
                ...
                "admin_notes": {
                    "type": "string",
                    "example": "Approved after HR validation"
                }
            }
        },
        ...
        "response.RegisterResponse": {
            ...
            "properties": {
                ...
                "data": {
                    "$ref": "#/definitions/response.RegisterResultData"
                },
                "message": {
                    "type": "string",
        ...
        "response.RegisterResultData": {
            ...
            "properties": {
                ...
                "message": {
                    "type": "string",
                    "example": "Registration submitted successfully. Your account is pending administrator approval."
                },
                "registration_id": {
                    "type": "integer",
                    "example": 1
        ...
        "response.RegistrationListResponse": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "integer",
